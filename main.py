...
class Building:
    def __init__(self, x, y, health):
        ...
        self.y = y - 130
        self.health = health
        self.images = [system.load_img('building.png'), system.load_img('building_1.png'),
                       system.load_img('building_2.png')]
        self.state = 0
...
while running:
    ...
    # 타워 체력
    pg.draw.rect(screen, (233, 0, 0),
                 (int(building.x) + 40, int(building.y), 260 * building.health / BUILDING_HEALTH, 10))
